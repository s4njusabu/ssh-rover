    ...
    pub fn colors(&self) -> ThemeColors {
        match self {
            ...
            Theme::Magenta => ThemeColors {
                ...
                warden_text: Color::LightMagenta,
            },
